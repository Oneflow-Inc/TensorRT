...
cd $TRT_RELEASE/python && pip3 install --user tensorrt-6.0.1.5-cp36-none-linux_x86_64.whl
cd $TRT_RELEASE/uff && pip3 install --user uff-0.6.5-py2.py3-none-any.whl
cd $TRT_RELEASE/graphsurgeon && pip3 install --user graphsurgeon-0.4.1-py2.py3-none-any.whl
